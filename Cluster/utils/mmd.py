...
class MMD:
    ...
    def get_noise(t: torch.Tensor, x:torch.Tensor, b: float) -> tuple[torch.Tensor, torch.Tensor]:
        """Because of the target simplification in the loss function module I also return the pre_noise
        Because of its use in the sampling and the noisifier module I also return the full noise
        """
